                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="fname" class="form-control form-control-danger" placeholder="Enter Firstename">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="email" class="form-control form-control-danger" placeholder="Enter Email">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
										 ...
										 <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control form-control-danger" placeholder="Enter Password">
                                                    </div>
                                                </div>
